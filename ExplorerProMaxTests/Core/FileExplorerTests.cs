...
namespace ExplorerProMax.Core.Tests
{
    ...
    public class FileExplorerTests
    {
        ...
        public void BackwardTest()
        {
            ...
            fe.ChangeDirectory(new PathEntity.DirectoryEntity(@"C:\"));
            fe.ChangeDirectory(new PathEntity.DirectoryEntity(@"C:\Users\"));
            fe.ChangeDirectory(new PathEntity.DirectoryEntity(@"C:\Users\Public\"));
        ...
        public void ForwardBranchTest()
        {
            ...
            fe.ChangeDirectory(new PathEntity.DirectoryEntity(@"C:\Users\Default\"));
