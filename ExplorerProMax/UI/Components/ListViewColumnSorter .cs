...
public class ListViewColumnSorter : IComparer
{
    ...
    {
        int compareResult;
        ListViewObjectItem listviewX, listviewY;

        // Cast the objects to be compared to ListViewItem objects
        listviewX = x as ListViewObjectItem;
        listviewY = y as ListViewObjectItem;

        // Compare the two items
        if (listviewX.Item is ParentLink)
            return int.MinValue;
        else if (listviewY.Item is ParentLink)
            return int.MaxValue;
